...
class _VideoPageState extends State<VideoPage>
    ...
    return FutureBuilder<CoverArtPalette>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              // ── Background layer ── Live Video for video page ──
              Positioned.fill(
                child: _buildBackground(musicService, theme),
              ),
  ...
  Widget _buildBackground(MusicService musicService, ThemeData theme) {
  ...
  Widget _buildHeroVideo(MusicService musicService, SettingsModel settings) {
    ...
    return Center(
      child: Hero(
        tag: 'music-art-${musicService.currentMusic?.id ?? 'none'}',
