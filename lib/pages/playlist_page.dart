    ...
    return Consumer2<MusicService, SettingsModel>(
      builder: (context, musicService, settings, child) {
        ...
        if (searchQuery.isNotEmpty) {
          playlists = playlists.where((pl) => pl.name.toLowerCase().contains(searchQuery.toLowerCase())).toList();
        }
          ...
          body: CustomScrollView(
            ...
            slivers: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                'Your Collection',
                                style: TextStyle(fontSize: 32.sp, fontWeight: FontWeight.w900, letterSpacing: -1.2, color: Colors.white),
                              ),
                              Text(
                          ...
                          GestureDetector(
                            ...
                            child: GlassContainer(
                              ...
                              blur: 10,
                              child: Icon(Icons.add_rounded, color: settings.accentColor, size: 28.s),
                            ),
                          ),
                        ],
                      ),
              ...
              if (playlists.isEmpty)
                SliverFillRemaining(child: _buildEmptyState(context, musicService))
              else
                SliverPadding(
                  padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
                  sliver: SliverGrid(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: _calculateAdaptiveCrossAxisCount(Responsive.screenWidth),
                      ...
                      (context, index) {
                        ...
                        return FadeInUpAnimation(
                          ...
                          child: PlaylistCard(
                            playlist: playlist,
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => PlaylistDetailPage(playlist: playlist)));
                            },
  ...
  Widget _buildEmptyState(BuildContext context, MusicService musicService) {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.auto_awesome_motion_rounded, size: 80.s, color: Colors.white10),
          SizedBox(height: 24.h),
          const Text('Your library is empty', style: TextStyle(color: Colors.white54, fontSize: 16)),
      ...
      builder: (context) => AlertDialog(
        ...
        content: GlassContainer(
          ...
          child: Column(
            ...
            children: [
              Text('Create Playlist', style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
              const SizedBox(height: 24),
              Container(
                ...
                child: TextField(
                  ...
                  decoration: const InputDecoration(hintText: 'Playlist Name', border: InputBorder.none, hintStyle: TextStyle(color: Colors.white24)),
                ),
              ),
